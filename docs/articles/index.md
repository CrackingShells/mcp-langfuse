...
Complete API documentation auto-generated from code docstrings. Includes detailed information about all modules, classes, functions, and their parameters. Use this as a technical reference when working with the codebase.

## [Appendices](appendices/index.md)

Supplementary content including the glossary, foundational concepts, and troubleshooting guides. Beginners should consult the appendices for background information on key concepts.
